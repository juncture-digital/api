...
from mdrender.gcs import Bucket as GCSBucket
from mdrender.s3 import Bucket as S3Bucket
ENV = 'gc' if 'K_CONFIGURATION' in os.environ else 'aws'

class Essays(object):

  def __init__(self, **kwargs):
    self.essays_store = S3Bucket (bucket='visual-essays') if ENV == 'aws' else GCSBucket(bucket='visual-essays')
